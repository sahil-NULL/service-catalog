...
class ComponentDependency(Base):
    ...
    source_component_id = Column(String, ForeignKey("components.id", ondelete="CASCADE"), primary_key=True)
    target_component_id = Column(String, ForeignKey("components.id", ondelete="CASCADE"), primary_key=True)
